...
80106cfe:	89 55 e4             	mov    %edx,-0x1c(%ebp)
	struct proc *curproc = myproc();
80106d01:	e8 aa c9 ff ff       	call   801036b0 <myproc>
80106d06:	89 c7                	mov    %eax,%edi
	a = PGROUNDUP(curproc->sz);
80106d08:	8b 00                	mov    (%eax),%eax
	acquire(&(shm_table.lock));
80106d0a:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
	a = PGROUNDUP(curproc->sz);
80106d11:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106d17:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
	acquire(&(shm_table.lock));
80106d1d:	e8 2e d4 ff ff       	call   80104150 <acquire>
80106d22:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
for (i = 0; i < 64; ++i){
80106d27:	8b 55 e4             	mov    -0x1c(%ebp),%edx
...
80106d36:	83 fb 40             	cmp    $0x40,%ebx
...
80106d3f:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
80106d42:	8b 04 85 f8 54 11 80 	mov    -0x7feeab08(,%eax,4),%eax
80106d49:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d50:	00 
80106d51:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d58:	00 
80106d59:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d5d:	05 00 00 00 80       	add    $0x80000000,%eax
80106d62:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106d66:	8b 47 04             	mov    0x4(%edi),%eax
80106d69:	89 04 24             	mov    %eax,(%esp)
80106d6c:	e8 df f7 ff ff       	call   80106550 <mappages>
80106d71:	85 c0                	test   %eax,%eax
80106d73:	0f 88 d6 00 00 00    	js     80106e4f <shm_open+0x15f>
			
			cprintf("ERROR");
		}
		shm_table.shm_pages[i].refcnt = shm_table.shm_pages[i].refcnt + 1;
80106d79:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
80106d7c:	83 04 85 fc 54 11 80 	addl   $0x1,-0x7feeab04(,%eax,4)
80106d83:	01 
		*pointer = (char*)a;
80106d84:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d87:	89 30                	mov    %esi,(%eax)
		curproc->sz = a + PGSIZE;
80106d89:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106d8f:	89 37                	mov    %esi,(%edi)
	}
...
80106da7:	90                   	nop
for (i = 0; i < 64; ++i){
80106da8:	bb f4 54 11 80       	mov    $0x801154f4,%ebx
...
80106dbb:	83 c3 0c             	add    $0xc,%ebx
80106dbe:	83 f8 40             	cmp    $0x40,%eax
80106dc1:	74 ce                	je     80106d91 <shm_open+0xa1>
			if(shm_table.shm_pages[i].id == 0){ //finds first empty 
80106dc3:	8b 0b                	mov    (%ebx),%ecx
80106dc5:	85 c9                	test   %ecx,%ecx
80106dc7:	75 ef                	jne    80106db8 <shm_open+0xc8>
				shm_table.shm_pages[i].id = id;
80106dc9:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106dcc:	c1 e3 02             	shl    $0x2,%ebx
80106dcf:	89 93 f4 54 11 80    	mov    %edx,-0x7feeab0c(%ebx)
				shm_table.shm_pages[i].frame = kalloc();
80106dd5:	e8 d6 b6 ff ff       	call   801024b0 <kalloc>
80106dda:	8d 93 c8 54 11 80    	lea    -0x7feeab38(%ebx),%edx
				memset(shm_table.shm_pages[i].frame,0,PGSIZE);
80106de0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106de7:	00 
80106de8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106def:	00 
				shm_table.shm_pages[i].frame = kalloc();
80106df0:	89 55 e4             	mov    %edx,-0x1c(%ebp)
				shm_table.shm_pages[i].refcnt = 1;
80106df3:	c7 83 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%ebx)
80106dfa:	00 00 00 
				memset(shm_table.shm_pages[i].frame,0,PGSIZE);
80106dfd:	89 04 24             	mov    %eax,(%esp)
				shm_table.shm_pages[i].frame = kalloc();
80106e00:	89 83 f8 54 11 80    	mov    %eax,-0x7feeab08(%ebx)
				memset(shm_table.shm_pages[i].frame,0,PGSIZE);
80106e06:	e8 85 d4 ff ff       	call   80104290 <memset>
				if (mappages(curproc->pgdir, (char*)a, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0){
80106e0b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106e0e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e15:	00 
80106e16:	8b 42 30             	mov    0x30(%edx),%eax
80106e19:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e20:	00 
80106e21:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e25:	05 00 00 00 80       	add    $0x80000000,%eax
80106e2a:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106e2e:	8b 47 04             	mov    0x4(%edi),%eax
80106e31:	89 04 24             	mov    %eax,(%esp)
80106e34:	e8 17 f7 ff ff       	call   80106550 <mappages>
80106e39:	85 c0                	test   %eax,%eax
80106e3b:	78 23                	js     80106e60 <shm_open+0x170>
				*pointer=(char *)a;
80106e3d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e40:	89 30                	mov    %esi,(%eax)
				curproc->sz = a + PGSIZE;
80106e42:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106e48:	89 37                	mov    %esi,(%edi)
				break;
80106e4a:	e9 42 ff ff ff       	jmp    80106d91 <shm_open+0xa1>
			cprintf("ERROR");
80106e4f:	c7 04 24 dd 78 10 80 	movl   $0x801078dd,(%esp)
80106e56:	e8 f5 97 ff ff       	call   80100650 <cprintf>
80106e5b:	e9 19 ff ff ff       	jmp    80106d79 <shm_open+0x89>
					cprintf("error");
80106e60:	c7 04 24 e3 78 10 80 	movl   $0x801078e3,(%esp)
80106e67:	e8 e4 97 ff ff       	call   80100650 <cprintf>
80106e6c:	eb cf                	jmp    80106e3d <shm_open+0x14d>
...
80106e81:	e8 ca d2 ff ff       	call   80104150 <acquire>
80106e86:	ba f4 54 11 80       	mov    $0x801154f4,%edx
	for(i=0; i<64; i++){
80106e8b:	31 c0                	xor    %eax,%eax
80106e8d:	eb 0c                	jmp    80106e9b <shm_close+0x2b>
80106e8f:	90                   	nop
80106e90:	83 c0 01             	add    $0x1,%eax
80106e93:	83 c2 0c             	add    $0xc,%edx
80106e96:	83 f8 40             	cmp    $0x40,%eax
80106e99:	74 31                	je     80106ecc <shm_close+0x5c>
		if (shm_table.shm_pages[i].id == id){
80106e9b:	39 1a                	cmp    %ebx,(%edx)
80106e9d:	75 f1                	jne    80106e90 <shm_close+0x20>
			shm_table.shm_pages[i].refcnt = shm_table.shm_pages[i].refcnt - 1;  
80106e9f:	8d 04 40             	lea    (%eax,%eax,2),%eax
80106ea2:	c1 e0 02             	shl    $0x2,%eax
80106ea5:	8b 98 fc 54 11 80    	mov    -0x7feeab04(%eax),%ebx
80106eab:	8d 53 ff             	lea    -0x1(%ebx),%edx
			if (shm_table.shm_pages[i].refcnt == 0) { //if refcnt is 0
80106eae:	85 d2                	test   %edx,%edx
			shm_table.shm_pages[i].refcnt = shm_table.shm_pages[i].refcnt - 1;  
80106eb0:	89 90 fc 54 11 80    	mov    %edx,-0x7feeab04(%eax)
			if (shm_table.shm_pages[i].refcnt == 0) { //if refcnt is 0
80106eb6:	75 14                	jne    80106ecc <shm_close+0x5c>
				//clears the shm_table
				shm_table.shm_pages[i].id = 0;
80106eb8:	c7 80 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%eax)
80106ebf:	00 00 00 
				shm_table.shm_pages[i].frame = 0;
80106ec2:	c7 80 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%eax)
80106ec9:	00 00 00 
			}
			break;
		}
	...
	release(&(shm_table.lock));
80106ecc:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ed3:	e8 68 d3 ff ff       	call   80104240 <release>
...
80106ed8:	83 c4 14             	add    $0x14,%esp
